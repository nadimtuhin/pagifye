...
/**
 * Awards_01 Widget Class
 */
class Awards_01 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-awards-01';
	}
	...
	public function get_title() {
		return esc_html__( 'Awards 01', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'awards', 'badge', 'recognition' ];
	}
