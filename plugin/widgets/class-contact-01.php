...
/**
 * Contact_01 Widget Class
 */
class Contact_01 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-contact-01';
	}
	...
	public function get_title() {
		return esc_html__( 'Contact 01', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'contact', 'form', 'email' ];
	}
