...
/**
 * Blog_05 Widget Class
 */
class Blog_05 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-blog-05';
	}
	...
	public function get_title() {
		return esc_html__( 'Blog 05', 'pagifye-elementor-widgets' );
	}
