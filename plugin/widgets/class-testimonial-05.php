...
/**
 * Testimonial_05 Widget Class
 */
class Testimonial_05 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-testimonial-05';
	}
	...
	public function get_title() {
		return esc_html__( 'Testimonial 05', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'testimonial', 'review', 'client' ];
	}
