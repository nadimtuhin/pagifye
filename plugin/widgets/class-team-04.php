...
/**
 * Team_04 Widget Class
 */
class Team_04 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-team-04';
	}
	...
	public function get_title() {
		return esc_html__( 'Team 04', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'team', 'member', 'card' ];
	}
