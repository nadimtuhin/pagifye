...
/**
 * Blog_03 Widget Class
 */
class Blog_03 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-blog-03';
	}
	...
	public function get_title() {
		return esc_html__( 'Blog 03', 'pagifye-elementor-widgets' );
	}
