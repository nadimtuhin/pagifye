...
/**
 * Content_02 Widget Class
 */
class Content_02 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-content-02';
	}
	...
	public function get_title() {
		return esc_html__( 'Content 02', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'content', 'features', 'image' ];
	}
