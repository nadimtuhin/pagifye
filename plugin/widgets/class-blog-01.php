...
/**
 * Blog_01 Widget Class
 */
class Blog_01 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-blog-01';
	}
	...
	public function get_title() {
		return esc_html__( 'Blog 01', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'blog', 'post', 'article' ];
	}
