 ...
 * Hero-06 Widget
 *
 * Full-width hero with background image, gradient overlay (light theme), and ratings.
 *
...
/**
 * Hero-06 Widget Class
 */
class Hero_06 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-hero-06';
	}
	...
	public function get_title() {
		return esc_html__( 'Hero 06', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'hero', 'banner', 'background', 'light' ];
	}
	...
	protected function render() {
		...
		<section style="position: relative; min-height: 830px; background-image: url(<?php echo esc_url( $bg_image ); ?>); background-size: cover; background-position: center;">
			<div style="position: absolute; inset: 0; background: linear-gradient(to left, transparent, rgba(255,255,255,0.1), white);"></div>

			<div class="container" style="position: relative;">
				<div style="max-width: 648px; padding: 184px 0 90px; display: flex; flex-direction: column; gap: 40px;">
					...
					<div style="display: flex; flex-direction: column; gap: 24px;">
						...
						<?php if ( ! empty( $settings['description'] ) ) : ?>
							<p style="font-size: 18px; font-weight: 700; color: #0F2C24; margin: 0;">
					...
					<?php if ( 'yes' === $settings['show_ratings'] ) : ?>
						<div style="display: flex; flex-direction: column; gap: 8px;">
							...
							<span style="font-size: 16px; font-weight: 700; color: #0F2C24;">
