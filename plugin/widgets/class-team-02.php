...
/**
 * Team_02 Widget Class
 */
class Team_02 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-team-02';
	}
	...
	public function get_title() {
		return esc_html__( 'Team 02', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'team', 'member', 'profile' ];
	}
