...
/**
 * Metrics_06 Widget Class
 */
class Metrics_06 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-metrics-06';
	}
	...
	public function get_title() {
		return esc_html__( 'Metrics 06', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'metrics', 'stats', 'number' ];
	}
