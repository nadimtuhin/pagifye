...
/**
 * Contact_04 Widget Class
 */
class Contact_04 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-contact-04';
	}
	...
	public function get_title() {
		return esc_html__( 'Contact 04', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'contact', 'form', 'info' ];
	}
