...
/**
 * Content_04 Widget Class
 */
class Content_04 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-content-04';
	}
	...
	public function get_title() {
		return esc_html__( 'Content 04', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'content', 'features', 'list' ];
	}
