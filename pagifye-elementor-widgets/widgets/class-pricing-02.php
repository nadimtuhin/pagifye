...
/**
 * Pricing_02 Widget Class
 */
class Pricing_02 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-pricing-02';
	}
	...
	public function get_title() {
		return esc_html__( 'Pricing 02', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'pricing', 'plan', 'table' ];
	}
