...
/**
 * Contact_02 Widget Class
 */
class Contact_02 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-contact-02';
	}
	...
	public function get_title() {
		return esc_html__( 'Contact 02', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'contact', 'form', 'address' ];
	}
