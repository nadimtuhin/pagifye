...
/**
 * Awards_04 Widget Class
 */
class Awards_04 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-awards-04';
	}
	...
	public function get_title() {
		return esc_html__( 'Awards 04', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'awards', 'badge', 'achievement' ];
	}
