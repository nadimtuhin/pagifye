<?php
/**
 * Navigation-05 Widget
 *
 * Standard navigation header with logo, menu items, dropdowns, and CTA buttons.
 *
...
/**
 * Navigation-05 Widget Class
 */
class Navigation_05 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-navigation-05';
	}
	...
	public function get_title() {
		return esc_html__( 'Navigation 05', 'pagifye-elementor-widgets' );
	}
	...
	private function register_style_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .pagifye-nav-05-header',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .pagifye-nav-05-header' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .pagifye-nav-05-logo img' => 'width: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
					'logo_type' => 'image',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .pagifye-nav-05-logo-text',
				'condition' => [
					'logo_type' => 'text',
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .pagifye-nav-05-logo-text' => 'color: {{VALUE}};',
				],
				'condition' => [
					'logo_type' => 'text',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .pagifye-nav-05-menu a',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .pagifye-nav-05-menu a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .pagifye-nav-05-menu' => 'gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'types'    => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .pagifye-nav-05-dropdown',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .pagifye-nav-05-dropdown a:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .pagifye-nav-05-dropdown a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .pagifye-nav-05-btn-sign-in' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'show_sign_in' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .pagifye-nav-05-btn-sign-in' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_sign_in' => 'yes',
				],
		...
		$this->add_group_control(
			...
			[
				'name'      => 'sign_in_border',
				'selector'  => '{{WRAPPER}} .pagifye-nav-05-btn-sign-in',
				'condition' => [
					'show_sign_in' => 'yes',
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .pagifye-nav-05-btn-get-started' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'show_get_started' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .pagifye-nav-05-btn-get-started' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_get_started' => 'yes',
				],
	...
	protected function render() {
		...
		<section class="min-h-screen">
			<header class="pagifye-nav-05-header relative flex items-center justify-between py-4 font-medium max-lg:pr-4 bg-pgfy-gray-500 text-white">
				<!-- Desktop -->
				<div class="container flex items-center lg:justify-between">
					<div class="flex items-center gap-10">
						<!-- Logo -->
						<a href="<?php echo esc_url( $settings['logo_link']['url'] ); ?>" class="pagifye-nav-05-logo">
							...
							<?php else : ?>
								<span class="pagifye-nav-05-logo-text"><?php echo esc_html( $settings['logo_text'] ); ?></span>
							<?php endif; ?>
						</a>

						<!-- Desktop Menu -->
						<nav>
							<ul class="pagifye-nav-05-menu flex gap-6 max-lg:hidden">
								<?php foreach ( $settings['menu_items'] as $item ) : ?>
									<li class="<?php echo 'yes' === $item['has_dropdown'] ? 'group relative' : ''; ?>">
										...
										<?php if ( 'yes' === $item['has_dropdown'] && ! empty( $item['dropdown_items'] ) ) : ?>
											<div class="pagifye-nav-05-dropdown invisible absolute left-0 top-full z-50 min-w-[200px] rounded-lg p-4 opacity-0 shadow-lg transition-all duration-300 group-hover:visible group-hover:opacity-100 bg-pgfy-gray-400">
					...
					<div class="flex gap-6 max-lg:hidden">
						<?php if ( 'yes' === $settings['show_sign_in'] ) : ?>
							<a href="<?php echo esc_url( $settings['sign_in_link']['url'] ); ?>" class="pagifye-nav-05-btn-sign-in group flex select-none items-center justify-center gap-1 text-nowrap rounded-full border text-base font-bold transition duration-300 ease-in-out max-lg:w-full sm:w-max px-8 py-3 border-pgfy-primary-500 text-white hover:bg-pgfy-primary-500 hover:text-pgfy-gray-400">
								<span><?php echo esc_html( $settings['sign_in_text'] ); ?></span>
							</a>
						<?php endif; ?>

						<?php if ( 'yes' === $settings['show_get_started'] ) : ?>
							<a href="<?php echo esc_url( $settings['get_started_link']['url'] ); ?>" class="pagifye-nav-05-btn-get-started group flex select-none items-center justify-center gap-1 text-nowrap rounded-full text-base font-bold transition duration-300 ease-in-out max-lg:w-full sm:w-max px-8 py-3 bg-pgfy-primary-500 text-pgfy-gray-500 hover:bg-pgfy-primary-600">
				...
				<div x-data="{ isOpen: false }" class="flex lg:hidden">
					...
					<div x-show="isOpen" style="display: none;">
						<div class="absolute inset-x-0 top-[70px] z-20 flex h-[calc(100vh-72px)] w-full flex-col justify-between overflow-y-auto px-4 pb-4 bg-pgfy-gray-500">
							...
							<div class="flex w-full flex-wrap gap-4 max-sm:flex-col">
								<?php if ( 'yes' === $settings['show_sign_in'] ) : ?>
									<a href="<?php echo esc_url( $settings['sign_in_link']['url'] ); ?>" class="group flex select-none items-center justify-center gap-1 text-nowrap rounded-full border text-base font-bold transition duration-300 ease-in-out max-lg:w-full sm:w-max px-8 py-3 border-pgfy-primary-500 text-white hover:bg-pgfy-primary-500 hover:text-pgfy-gray-400">
										<span><?php echo esc_html( $settings['sign_in_text'] ); ?></span>
									</a>
								<?php endif; ?>

								<?php if ( 'yes' === $settings['show_get_started'] ) : ?>
									<a href="<?php echo esc_url( $settings['get_started_link']['url'] ); ?>" class="group flex select-none items-center justify-center gap-1 text-nowrap rounded-full text-base font-bold transition duration-300 ease-in-out max-lg:w-full sm:w-max px-8 py-3 bg-pgfy-primary-500 text-pgfy-gray-500 hover:bg-pgfy-primary-600">
										<span><?php echo esc_html( $settings['get_started_text'] ); ?></span>
									</a>
								<?php endif; ?>
							</div>
