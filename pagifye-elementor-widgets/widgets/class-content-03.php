...
/**
 * Content_03 Widget Class
 */
class Content_03 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-content-03';
	}
	...
	public function get_title() {
		return esc_html__( 'Content 03', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'content', 'features', 'text' ];
	}
