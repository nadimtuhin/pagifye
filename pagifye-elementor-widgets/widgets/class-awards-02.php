...
/**
 * Awards_02 Widget Class
 */
class Awards_02 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-awards-02';
	}
	...
	public function get_title() {
		return esc_html__( 'Awards 02', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'awards', 'badge', 'logo' ];
	}
