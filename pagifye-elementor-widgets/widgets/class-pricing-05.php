...
/**
 * Pricing_05 Widget Class
 */
class Pricing_05 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-pricing-05';
	}
	...
	public function get_title() {
		return esc_html__( 'Pricing 05', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'pricing', 'plan', 'card' ];
	}
