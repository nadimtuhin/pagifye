...
/**
 * Metrics_02 Widget Class
 */
class Metrics_02 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-metrics-02';
	}
	...
	public function get_title() {
		return esc_html__( 'Metrics 02', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'metrics', 'stats', 'counter' ];
	}
