...
/**
 * Team_01 Widget Class
 */
class Team_01 extends Base_Widget {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'pagifye-team-01';
	}
	...
	public function get_title() {
		return esc_html__( 'Team 01', 'pagifye-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return [ 'pagifye', 'team', 'member', 'staff' ];
	}
